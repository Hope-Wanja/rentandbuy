...
class ForSalePage extends StatelessWidget {
  ...
  Widget _buildCategorySlideshow({required String title, required BuildContext context, required List<SaleItem> items}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  Widget _buildItemCard(BuildContext context, SaleItem item) {
    return Card(
